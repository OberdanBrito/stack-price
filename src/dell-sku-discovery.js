...
const DellScraper = require('./scraper/vendors/dell-scraper');
...
program
  .name('dell-sku-discovery')
  .description('Script para descoberta de SKUs Dell em páginas de categoria/busca')
  .version('1.0.0');

program
  .requiredOption('--url <url>', 'URL da página de categoria/busca da Dell')
  ...
  .option('--fabricante <nome>', 'Fabricante para salvar no banco (default: Dell)', 'Dell');
...
async function main() {
  ...
  try {
    console.log('=== Dell SKU Discovery ===');
